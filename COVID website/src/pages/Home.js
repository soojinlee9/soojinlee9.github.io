            ...
            <div className="covidData">
                <a href="/cases">
                    <div className="cases">
                        ...
                        <h1 className="numCase">{countryData.Countries && countryData.Countries[219] && countryData.Countries[219].TotalConfirmed} </h1> 
                        <h3>Number of Cases Confirmed Today</h3>
                        <h1 className="numTodayCase">{countryData.Countries && countryData.Countries[219] && countryData.Countries[219].NewConfirmed} </h1>
                    </div>
                </a>
                <a href="/deaths">
                    <div className="deaths">
                        <h3>Total Number of Deaths in {country}</h3>
                        <h1 className="numDeaths">{countryData.Countries && countryData.Countries[219] && countryData.Countries[219].TotalDeaths} </h1>
                        <h3>Number of Deaths Today</h3>
                        <h1 className="numTodayDeaths">{countryData.Countries && countryData.Countries[219] && countryData.Countries[219].NewDeaths} </h1>
                    </div>
                </a>
                ...
                {/* green background gets brighter as total number recovered gets closer to total number confirmed */}
                    ...
                    <h1>{countryData.Countries && countryData.Countries[219] && countryData.Countries[219].TotalRecovered} </h1>
                    <h3>Number of Recovered Today</h3>
                    <h1>{countryData.Countries && countryData.Countries[219] && countryData.Countries[219].NewRecovered} </h1>
                </div>
            </div>
            <div className="chart">
                <Chart />
